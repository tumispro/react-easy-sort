...
| **autoScroll**           | Determines whether the containing element (or window) should scroll during sort (⚠️ note that currently only vertical scroll is supported) |                   `boolean`                    |         `false` |
